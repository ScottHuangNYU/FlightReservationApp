...
import com.scott.flightreservation.repos.PassengerRepository;
import com.scott.flightreservation.repos.ReservationRepository;
import com.scott.flightreservation.util.EmailUtil;
import com.scott.flightreservation.util.PDFGenerator;

@Service
public class ReservationServiceImpl implements ReservationService {

	@Value("${com.scott.flightreservation.itinerary.dirpath}")
